...
01	HTML 기본 뼈대
02	제목, 문단, 링크, 이미지
03	전역 속성 (draggable, hidden, id, tabindex 등)
04	지역 속성 (target, width, height)
05	CSS 적용 방법 3가지 + 주요 스타일
06	의미 있는 태그 (strong, em, mark 등)
07	ul, ol, dl 목록 태그
08	table, rowspan, colspan
09	input type 종류 전체
10	input 속성 (readonly, disabled, required 등)
11	select, textarea, fieldset, datalist
12	form의 GET/POST
13	iframe으로 페이지 삽입
14	video 태그
15	audio 태그
